  ...
  return (
   ...
   viewport={{once:true}}
     className='container mx-auto py-4 pt-20 px-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden' id='Projects'>
        ...
        <p className='text-center text-gray-500 mb-8 max-w-80 mx-auto'>Discover the quality and craftsmanship of our completed projects.</p>
        {/* Slidder buttons next and prev */}
