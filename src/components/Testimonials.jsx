  ...
  return (
   ...
   viewport={{once:true}}
     className='container mx-auto py-10 lg:px-32 w-full overflow-hidden' id='Testimonials'>
       ...
       <p className='text-center text-gray-500 mb-12 max-w-80 mx-auto'>See why our clients trust us—read our 
       glowing testimonials and learn how we've helped countless
        buyers and sellers achieve their real estate goals.</p>
